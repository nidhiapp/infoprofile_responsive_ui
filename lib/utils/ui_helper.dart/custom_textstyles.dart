...
class AppStyle {
   static double getResponsiveFontSize(BuildContext context, double baseSize) {
    ...
    // You can adjust the factors according to your preference
    double scaleFactor = w / 1075.0; // Assuming 375.0 is the base width
  ...
  static TextStyle fiveOneFourBlack = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    color: AppColors.darkblackTextColor,
  ));
  static TextStyle sevenOneSixWhite = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w700,
    color: AppColors.logincardColor,
  ));
  static TextStyle sixOneFourBlack = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 14,
  ...
  static TextStyle sixOneTwoBlueUl = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w600,
    color: AppColors.primaryColor,
  ...
  static TextStyle sixOnezeroTs = GoogleFonts.poppins(
      textStyle: const TextStyle(
          fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.greyCol));
  static TextStyle sixOneFourGreyTs = GoogleFonts.poppins(
      textStyle: const TextStyle(
          fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.greyCol));
  ...
  static TextStyle sevenFiveZeroBlack = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 50,
    fontWeight: FontWeight.w700,
    color: AppColors.darkblackTextColor,
  ...
  static TextStyle sevenThreeFiveBlack= GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 35,
    fontWeight: FontWeight.w700,
    color: AppColors.darkblackTextColor,
  ));
  static TextStyle sevenThreeFiveBlue = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 35,
    fontWeight: FontWeight.w700,
    color: AppColors.primaryColor,
  ...
  static TextStyle sevenFiveZeroBlue = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 50,
    fontWeight: FontWeight.w700,
    color: AppColors.primaryColor,
  ));
  static TextStyle fourOneEightBlack = GoogleFonts.roboto(
      textStyle: const TextStyle(
    fontSize: 18,
    fontWeight: FontWeight.w400,
    color: AppColors.blackColor,
  ));
  static TextStyle fiveTwoFiveBlack = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 25,
    fontWeight: FontWeight.w500,
    color: AppColors.blackNormalTextColor,
  ...
  static TextStyle fiveTwoZeroBlack = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.w500,
    color: AppColors.blackNormalTextColor,
  ...
  static TextStyle  fiveTwoZeroBlue = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.w500,
    color: AppColors.primaryColor,
  ));
  static TextStyle fiveOneFiveBlue = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 15,
    fontWeight: FontWeight.w500,
    color: AppColors.primaryColor,
  ));
  static TextStyle fiveOneFiveBlack = GoogleFonts.poppins(
      textStyle: const TextStyle(
    fontSize: 15,
    fontWeight: FontWeight.w500,
    color: AppColors.blackNormalTextColor,
  ...
  static TextStyle font400_14Ts = GoogleFonts.poppins(
      textStyle: const TextStyle(
          fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.muteCol));
  ...
  static TextStyle imgtextcol = GoogleFonts.poppins(
      textStyle: const TextStyle(
          fontSize: 16, fontWeight: FontWeight.w400, color: AppColors.muteCol));
...
static TextStyle fontSixOneSixBlackTs(BuildContext context) {
  ...
  static TextStyle connectionHeader = GoogleFonts.poppins(
      textStyle: const TextStyle(
          fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFFA4A2A2)));
  ...
  static TextStyle sixOneSixwhite = GoogleFonts.poppins(
    textStyle: const TextStyle(
      color: AppColors.logincardColor,
      fontSize: 16,
      fontWeight: FontWeight.w600,
