...
import 'package:info_profile_ui/components/log_out.dart';
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: InkWell(
                  onTap: () async {
                    ...
                    if(searchText == null || searchText.isEmpty || searchText.length < 2) return;
                    FirebaseFeedApi api = FirebaseFeedApi();
                    ShowSearchDialog.showUserSearchDialog(context, await api.searchUsers(searchText), api.followUser);
